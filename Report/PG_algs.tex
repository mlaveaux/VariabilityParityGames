As argued before we want to inspect local solving strategies for VPGs, we can locally solve a VPG independently by using local parity game algorithms. The two parity game algorithms introduced in the preliminaries (Zielonka's recursive algorithm and the fixed-point iteration algorithm) can be turned into local variants to solve VPGs locally and independently.
