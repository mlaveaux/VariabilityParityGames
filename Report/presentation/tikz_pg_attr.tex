...
\begin{tikzpicture}[->,scale=0.9, every node/.style={scale=0.8}]
	...
	\node[even,label=center:1,fill=\fillva,label=north:$v_1$] (v1) at (10,10)	{};
	\node[odd, label=center:3,fill=\fillvb,label=north:$v_2$] (v2) at (11.5,10)	{};
	\node[odd, label=center:3,fill=\fillvc,label=north:$v_3$] (v3) at (13,10)	{};
	\node[even,label=center:4,fill=\fillvd,label=north:$v_4$] (v4) at (14.5,10)	{};
	\node[even,label=center:2,fill=\fillve,label=north:$v_5$] (v5) at (16,10)	{};
	...
	\node[even,label=center:0,fill=\fillvh,label=south:$v_8$] (v8) at (14.5,8.5){};
	...
	\path (v7) edge (v6);
	\path (v3) edge (v8);
	\path (v4) edge [bend right] (v8);
	\path (v8) edge [bend right] (v4);
