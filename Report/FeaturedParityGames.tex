...
\begin{definition}
	...
	\end{cases}\]
\end{definition}
Consider our working example which we extend to an FTS depicted in figure \ref{fig:exverfts}, for this example we have features $N = \{f\}$ and products $P = \{\emptyset, \{f\}\}$.
\begin{figure}[h]
	\centering
