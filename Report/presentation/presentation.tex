...
\definecolor{semihighlightgraph}{HTML}{c9e7ab}

\pgfdeclarepatternformonly{softcrosshatch}{\pgfqpoint{-1pt}{-1pt}}{\pgfqpoint{4pt}{4pt}}{\pgfqpoint{3pt}{3pt}}%
{
	\pgfsetstrokecolor{highlightgraph}
...
\input{tikz_vpg_attr}%
	...
	\begin{column}{0.52\textwidth}
		...
		\end{tabular}}
	\setcounter{picite}{0}\stepcounter{picite}\stepcounter{picite}\stepcounter{picite}\stepcounter{picite}\stepcounter{picite}\stepcounter{picite}%
\only<\thepicite>{
	\begin{align*}
...
\stepcounter{picite}\only<\thepicite>{
	...
	\end{column}
\end{columns}
\setcounter{picite}{0}\stepcounter{picite}\stepcounter{picite}%
\stepcounter{picite}\only<\thepicite>{%
\mbox{}\vfill
\begin{align*}
...
\begin{columns}[T]
	\begin{column}{0.5\textwidth}
		\begin{figure}[H]
			\input{"Minepump - Zlnk product based_Zlnk fam based - explicit_Zlnk fam based - symbolic_"}
	...
	\begin{column}{0.5\textwidth}
		\begin{figure}[H]
			\input{"Elevator - Zlnk product based_Zlnk fam based - explicit_Zlnk fam based - symbolic_"}
