...
Given an FTS $M$, that models the behaviour of an SPL, with products $P$ and modal $\mu$-calculus formula $\varphi$ we want to find the products in $P$ that satisfy $\varphi$. Formally we want to find set $P_s$ such that:
\begin{itemize}
