...
Note that pessimistic parity games are not necessarily total. A play in a parity game that is not total might result in a finite path, in such a case the player that cannot make a move looses the play.
...
\paragraph{Pessimistic subgames}
...
\subsubsection{A parity game algorithm using pre-solved vertices}
