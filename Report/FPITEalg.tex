...
\begin{example}
	...
	\begin{figure}[h]
		...
		\begin{subfigure}{1\textwidth}
			...
			\end{tikzpicture}
			\caption{Pessimistic parity game $G_{\triangleright0}$}
		\end{subfigure}\\
		\begin{subfigure}{1\textwidth}
			\centering
			\begin{tikzpicture}[->]
				...
				\path (v2) edge[loop right] (v2);
			\end{tikzpicture}
			\caption{Pessimistic parity game $G_{\triangleright1}$}
		\end{subfigure}
